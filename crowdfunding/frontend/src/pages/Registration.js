...
export default class Registration extends Component {
	...
	handleSubmit = event => {
		...
		const { username, password_1, password_2, email, first_name, last_name, skills, groups } = this.state;
							...
							<Form.Group className="mb-3" >
								...
								{this.state.info_groups.length === 0 ?
									...
									<div>
										...
										<Form.Check
											type='radio'
											value={this.state.info_groups[0].name}
											checked={this.state.groups == this.state.info_groups[0].name}
											label={this.state.info_groups[0].name}
											onChange={this.handleRadioChange.bind(this)}
										/>
										<Form.Check
											type='radio'
											value={this.state.info_groups[1].name}
											checked={this.state.groups == this.state.info_groups[1].name}
								...
								{this.state.errorMessage && <Form.Text className="text-danger"> {this.state.errorMessage.groups} </Form.Text>}
							</Form.Group>
