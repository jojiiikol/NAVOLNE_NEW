...
# TODO:     * Новая колонка
# TODO:     * Новая таблица/Чоисы
# TODO: При потверждении закрытия вся сумма летит в ЛК создателю
# TODO: Перевод проекта на статус завершенного
# TODO: Перевод проекта на статус завершения сбора:
# TODO:     * Сделать изменение статуса:
# TODO:         * По времени
# TODO:         * По сумме
# TODO: Проверка при наборе суммы
# TODO: Добавить админу просмотр статус кода
# TODO: -----------------------------------------------
